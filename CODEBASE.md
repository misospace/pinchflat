...
| File                              | Used in    | Purpose                                                                                                                                                                                                     |
| --------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docker/ci-base.Dockerfile`       | CI/release | Shared base image (`ghcr.io/misospace/pinchflat-ci-base`) — provides Elixir, OTP, Node, FFmpeg, yt-dlp, Deno, Apprise. Both dev and selfhosted images build FROM it so toolchain versions live in one place |
