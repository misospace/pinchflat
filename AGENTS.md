...
| `CODEBASE.md:140` names the base image `ghcr.io/communitymaintained/pinchflat-ci-base`        | CI pulls `ghcr.io/misospace/pinchflat-ci-base:latest` (`ci.yml`, `ci-base.yml`); the namespace rehome (`81a7e4f`) didn't reach every doc                                                                                                                 |
